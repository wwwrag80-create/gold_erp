...
HINTS = {
    ...
    "المبيعات": "فواتير البيع في الفترة، وقيودٌ يومية جعلته مديناً "
                "مقابل جهةٍ أو بضاعة — وفي النقد: قيمة ما سُكّر من ذهبه",
    "المرتجع": "ما رجع من العميل بفواتير المرتجع",
    "صافي المبيعات": "رصيدٌ سابق + المبيعات − المرتجع: كل ما يُطالَب به "
                     "العميل",
    "السداد": "ما قبضه المصنع من العميل: سندات القبض (ومعها خصم السند)،"
              " والتسكير (ذهبٌ سُوّي بسعره)، وما سُدّد بقيدٍ يومي"
              " — والجدول مرتّبٌ بالأعلى سداداً",
    "حركات أخرى": "سند صرف، تسوية، أو قيدٌ يومي لا يُصنَّف — (+) تزيد ما "
                  "على العميل و(−) تنقصه",
